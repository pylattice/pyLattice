...
% (the parfor eats too much memory when processing large files since matlab 
% is not exactly high performance. Parfor therefore omitted. )

function II_stitchMatlabFramesTogether(parameterFile)
disp('--------------------------------------------------------------')
