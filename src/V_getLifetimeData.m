...
% Joh Schöneberg 2018, based on Francois Aguet, 05/2012

function [lftData, rmIdx] = V_getLifetimeData(data, varargin)
...
lifetimeFilename = inputParametersMap('lifetimeFilename');
...
for i = 1:nd
    ...
    fpath = [resultsPath '/' lifetimeFilename]
